...
type DatabaseQueryNodeData = ReactFlowNodeData;

export default function DatabaseQueryNode({ data, selected, id }: NodeProps) {
      ...
      <CardContent className="pt-0">
        ...
        {nodeData.queryType && (
          <div className="mt-2 text-xs text-gray-600">
            <span className="font-medium">Type:</span> {nodeData.queryType}
          </div>
        )}
      </CardContent>
      <Handle
